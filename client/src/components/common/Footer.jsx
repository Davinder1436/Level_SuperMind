...
const Footer = () => {
  return (
    <footer className="relative bg-[#FFFFF4] pt-20 overflow-hidden">
      {/* Top Border Design */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-16 border-t-2 border-[#151616]">
          ...
          <div className="md:col-span-2 space-y-6">
            <motion.div
              ...
              <h2 className="text-3xl font-bold">SoulBuddy</h2>
            </motion.div>
            <p className="text-[#151616]/70 max-w-md">
              Empowering your spiritual journey through personalized guidance
              and astrological insights. Join us in exploring the depths of your
              inner self.
            </p>
